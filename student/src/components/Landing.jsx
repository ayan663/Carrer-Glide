...
function Landing() {
  return (
    <>
      <div className=" mx-6 mt-8">
        <div className="flex items-center justify-center">
          ...
          <div className="mr-8">  {/* Adjust margin-right (mr-8) as needed */}
            ...
            {/* hover:font-bold */}
            <p className="font-normal  max-w-lg text-xl leading-loose text-gray-900 dark:text-white">
      ...
      {/* cards  */}
      <div className="grid grid-cols-4 mx-6 justify-evenly gap-6 h-80">
        <div className=" bg-white bg-opacity-20 bg-cover bg-center">
          {/*<img
          ...
          <div className="text-white flex items-center h-full">
            <div className="bg-blue-600 bg-opacity-95 p-3 opacity-60 backdrop-blur-lg lg:p-12 h-full">
          ...
          <div className="flex flex-col items-center justify-between">
            <div className="">
              <div className="max-w-3xl">
                <h1 className="mb-6 text-center text-5xl font-light tracking-tight text-white sm:text-5xl lg:text-7xl">Easily improve <span className="my-1 inline-block font-serif font-bold text-white"> customer relations </span></h1>
                <p className="text-center text-base text-gray-100">Eager to begin the adventure? The time is now. Embark on this exciting journey with us.Your future is waiting.</p>
              </div>
              <form method="POST" action="#" className="mx-auto mt-12 mb-2 max-w-xl sm:rounded-xl sm:border sm:border-gray-100 sm:bg-white sm:p-2 sm:shadow">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                  <div className="relative text-gray-500 sm:w-7/12">
                    <label for="email" className="sr-only border-gray-300"></label>
                  ...
                  <button type="submit" className="group flex items-center justify-center rounded-xl bg-blue-700 px-6 py-4 text-white transition">
                    <span className="group flex w-full items-center justify-center rounded text-center font-medium">Free Trial</span>
            ...
            <div className="relative mt-20 hidden lg:block">
              ...
              <div className="w-fit mx-auto flex overflow-hidden rounded-3xl bg-orange-400" role="image-container"></div>
            </div>
          </div>
        </div>
      </div> */}
        ...
        <div className="relative mx-auto max-w-screen-lg px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex flex-col items-center">
            <div className="text-center">
              <p className="text-lg font-medium text-blue-600">What Users can expect from us </p>
              <h2 className="mt-4 text-3xl font-bold text-blue-900 sm:text-4xl xl:text-5xl">Upcoming Features</h2>
            </div>

            {/* <div className="order-3 mt-8 text-center md:mt-16">
              <button className="mb-20 rounded-lg border-2 border-blue-700 bg-blue-700 px-6 py-2 font-medium text-white transition hover:translate-y-1">More reviews on TrustPilot</button>
            </div> */}
            ...
            <div className="relative mx-auto mt-20 grid max-w-lg grid-cols-1 gap-16 md:max-w-none md:grid-cols-2 lg:gap-20">
              <div className="flex flex-col border-l-2 border-b-8 pb-4 border-blue-900 shadow-blue-200">
                <div className="flex flex-1 flex-col justify-between px-5">
                  <div className="flex-1">
                    <p className="border-blue-500 text-xl font-black">Skill Gap page</p>

                    <blockquote className="mt-8 flex-1">
                      <p className="leading-relaxed text-blue-900">Fetched Coerce Link (AI Fetches Coerce)
              ...
              <div className="flex flex-col border-l-2 border-b-8 pb-4 border-blue-900 shadow-blue-200">
                <div className="flex flex-1 flex-col justify-between px-5">
                  <div className="flex-1">
                    <p className="border-blue-500 text-xl font-black">Job Seeker Dashboard</p>

                    <blockquote className="mt-8 flex-1">
                      <p className="leading-relaxed text-blue-900"> Name, Contact personal Details
              ...
              <div className="flex flex-col border-l-2 border-b-8 pb-4 border-blue-900 shadow-blue-200">
                <div className="flex flex-1 flex-col justify-between px-5">
                  <div className="flex-1">
                    <p className="border-blue-500 text-xl font-black">Enter your Skill</p>

                    <blockquote className="mt-8 flex-1">
                      <p className="leading-relaxed text-blue-900">Based on Skill particular Question set get Fetched 
              ...
              <div className="flex flex-col border-l-2 border-b-8 pb-4 border-blue-900 shadow-blue-200">
                <div className="flex flex-1 flex-col justify-between px-5">
                  <div className="flex-1">
                    <p className="border-blue-500 text-xl font-black">Job Recommendation Page
                    </p>

                    <blockquote className="mt-8 flex-1">
                      <p className="leading-relaxed text-blue-900">: Get Lists of Job (Ai fetched).</p>
                    </blockquote>
                  </div>
                </div>
                </div>
                ...
                <div className="flex flex-1 flex-col justify-between px-5">
                  <div className="flex-1">
                    <p className="border-blue-500 text-xl font-black">Competency Diagnostic
                    </p>

                    <blockquote className="mt-8 flex-1">
                      <p className="leading-relaxed text-blue-900">Calculating user competency scores based on assessments, helping to identify skill gaps and provide personalized learning recommendations..</p>
                    </blockquote>
                  </div>
                </div>
                </div>
                ...
                <div className="flex flex-1 flex-col justify-between px-5">
                  <div className="flex-1">
                    <p className="border-blue-500 text-xl font-black">Real Time Job Market Inseights
                    </p>

                    <blockquote className="mt-8 flex-1">
                      <p className="leading-relaxed text-blue-900">Interactive dashboards that provide insights into trending jobs, in-demand skills, and salary benchmarks based on user skill levels.</p>
                    </blockquote>
                  </div>
                </div>
                </div>
      ...
      <div className=" bg-gray-700 px-4 py-6 sm:flex sm:items-center sm:justify-between">
